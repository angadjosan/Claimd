...
import { demoApiService, type ApplicationListItem } from '../../services/demoApi';
...
export default function DemoDashboard() {
  ...
  const loadApplications = async () => {
    try {
      setLoading(true);
      setError(null);
      const data = await demoApiService.getApplications(getDemoHeaders);
      ...
      <div className="pt-24 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Review and manage assigned SSDI applications (Demo Mode)</p>
          </div>
          ...
          {applications.length === 0 ? (
            <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-600">You don't have any demo applications assigned to review yet.</p>
            </div>
          ) : (
                    ...
                    {applications.map((app) => (
                      <tr key={app.application_id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <Link
                            to={`/demo/caseworker/dashboard/applications/${app.application_id}`}
