    ...
    <div className="bg-white text-gray-900 overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute left-1/2 top-[-200px] h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-purple-500/10 blur-3xl" />
          <div className="absolute left-1/3 top-[100px] h-[400px] w-[400px] rounded-full bg-pink-500/5 blur-3xl" />
        </div>
      ...
      <section id="how" className="relative py-32 px-6 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Step 1 */}
            <div className="group">
              <div className="mb-8 p-8 bg-gray-50 backdrop-blur-xl border border-gray-200 rounded-2xl hover:border-[#8B5CF6]/50 hover:bg-gray-100 transition-all">
                <div className="aspect-[4/3] bg-gradient-to-br from-[#8B5CF6]/10 to-[#EC4899]/5 rounded-xl flex items-center justify-center mb-6">
                  {/* Applicant UI mockup */}
            ...
            <div className="group">
              <div className="mb-8 p-8 bg-gray-50 backdrop-blur-xl border border-gray-200 rounded-2xl hover:border-[#8B5CF6]/50 hover:bg-gray-100 transition-all">
                <div className="aspect-[4/3] bg-gradient-to-br from-[#EC4899]/10 to-[#8B5CF6]/5 rounded-xl flex items-center justify-center mb-6">
            ...
            <div className="group">
              <div className="mb-8 p-8 bg-gray-50 backdrop-blur-xl border border-gray-200 rounded-2xl hover:border-[#8B5CF6]/50 hover:bg-gray-100 transition-all">
                <div className="aspect-[4/3] bg-gradient-to-br from-[#3B82F6]/10 to-[#8B5CF6]/5 rounded-xl flex items-center justify-center mb-6">
