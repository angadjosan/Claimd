export default function MinimalProblem() {
  return (
    <section className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white relative z-20 text-gray-900 flex items-center justify-center py-32 px-6">
      <div className="max-w-6xl mx-auto w-full relative z-10">
        <div className="text-center mb-24">
          <div className="text-xs text-gray-400 uppercase tracking-widest mb-6 font-medium">The Challenge</div>
          <h2 className="text-5xl md:text-7xl font-light mb-6 text-gray-900 leading-tight">
            940,000 Americans are waiting<span className="text-red-500">.</span>
          </h2>
