...
export const Step3Children: React.FC<StepProps> = ({ formData, updateFormData }) => {
  ...
  const updateChildStatus = (index: number, statusField: keyof Child['child_status'], value: boolean) => {
    const newChildren = [...formData.children];
    newChildren[index] = {
      ...newChildren[index],
      child_status: {
        ...
        renderItem={(child, index) => (
          <div className="space-y-4">
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <h3 className="text-sm font-medium text-gray-700 mb-3">Child Status</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                />
                <CheckboxField
                  label="Age 18-19 in secondary school full time"
